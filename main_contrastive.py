...
if __name__ == "__main__":
    ...
    parser.add_argument('--configs', default='configs/cityscapes/R_101_D_8.json', type=str,
    ...
    # ***********  Params for model.  **********
    parser.add_argument('--model_name', default='deeplab_v3_contrast', type=str,
    ...
    parser.add_argument('--loss_type', default='contrast_auxce_loss', type=str,
