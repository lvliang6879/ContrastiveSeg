...
class Trainer(object):
    def __init__(self, configer):
        ...
        self.writer = SummaryWriter('RS_runs/trainer_contrastive')
    ...
    def __train(self):
        ...
        for i, data_dict in enumerate(self.train_loader):
            ...
            if self.configer.get('iters') % self.configer.get('solver', 'display_iter') == 0 and \
                ...
                self.writer.add_scalar("train_losses", self.train_losses.avg, self.configer.get('iters'))
    ...
    def __val(self, data_loader=None):
        ...
        self.writer.add_scalar("mean_miou", self.evaluator.running_scores['seg'].get_mean_iou(), self.configer.get('iters'))
        self.writer.add_scalar("pixel_acc", self.evaluator.running_scores['seg'].get_pixel_acc(), self.configer.get('iters'))
